...
const GroupAnalyzePage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStatistics = async () => {
      try {
        setLoading(true);
        // In a real app, this would call an API endpoint to get group statistics
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead>Task Difficulty</TableHead>
                      ...
                      <TableBody>
                        {statistics?.memberContributions?.map((member, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>{member.contributionFactors.taskDifficulty}</TableCell>
